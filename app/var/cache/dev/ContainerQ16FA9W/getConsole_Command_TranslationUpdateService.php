...
$this->privates['console.command.translation_update'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationUpdateCommand($a, ($this->privates['translation.reader'] ?? $this->load('getTranslation_ReaderService.php')), ($this->privates['translation.extractor'] ?? $this->load('getTranslation_ExtractorService.php')), 'en', ($this->targetDirs[3].'/translations'), ($this->targetDirs[3].'/templates'), [0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations'), 1 => ($this->targetDirs[3].'/vendor/symfony/security-core/Resources/translations'), 2 => ($this->targetDirs[3].'/translations/')], [0 => ($this->targetDirs[3].'/vendor/symfony/framework-bundle/Command/TranslationDebugCommand.php'), 1 => ($this->targetDirs[3].'/vendor/symfony/validator/Util/LegacyTranslatorProxy.php'), 2 => ($this->targetDirs[3].'/vendor/symfony/framework-bundle/CacheWarmer/TranslationsCacheWarmer.php'), 3 => ($this->targetDirs[3].'/vendor/symfony/translation/DataCollector/TranslationDataCollector.php'), 4 => ($this->targetDirs[3].'/vendor/symfony/twig-bridge/Extension/TranslationExtension.php'), 5 => ($this->targetDirs[3].'/vendor/jms/serializer/src/Handler/FormErrorHandler.php')]);
