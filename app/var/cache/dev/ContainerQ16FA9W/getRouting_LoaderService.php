...
$c = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->targetDirs[3].'/src/Infrastructure/Resources'), [0 => ($this->targetDirs[3].'/src/Infrastructure')]);
$d = new \FOS\RestBundle\Routing\Loader\RestRouteProcessor();
$e = ($this->privates['annotations.reader'] ?? $this->getAnnotations_ReaderService());
